...
const change = {
  ...
  estado: 'pendiente'  // El estado inicial de la tarea
};
// Función para manejar los cambios de propiedades
const filtrado = {
  set: function(projects, status, valor) {
    ...
    return true;  // Indica que la operación de asignación fue exitosa
  }
};
// Crear un Proxy para el objeto 'tarea'


const filtroProxy = new Proxy(change, filtrado);
// Cambiar el estado de la tarea a 'completada'
filtroProxy.estado = 'terminado';  // Esto dispara el mensaje de alerta
